...
Milestone 1 nodes: 4 Triggers (Clock, On Hit, On Kill, On Pickup), 3 Actions
(Bolt, Nova, Arc), 3 Modifiers (Split, Amplify, Echo). The remaining v1 roster in
GDD §22 is mostly data entry against the same primitives.
